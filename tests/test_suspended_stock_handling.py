...
class TestPaperTradingSuspendedHandling:
    ...
    def test_suspended_stock_skipped_in_stop_loss_check(self, temp_storage):
        """测试：停牌股票在止损检查中被跳过"""
        from scripts.paper_trade import _check_stop_loss, PaperTradingRunner
        ...
        with patch('scripts.paper_trade.DataLoader') as MockDataLoader:
    ...
    def test_sell_suspended_stock_added_to_pending_sells(self, sample_account_with_position, temp_storage):
...
class TestBacktestSuspendedHandling:
    ...
    def test_suspended_stock_sell_deferred_in_backtest(self):
        ...
        with patch.object(engine, '_get_trade_price', return_value=10.0), \
