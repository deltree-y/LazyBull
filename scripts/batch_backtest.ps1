...
# ── 模型与信号 ──────────────────────────────────────────────
$mv_list                 = @(3683,3671,3659,3647,3635,3623,3611,3599,3587,3575,3563,3551,3539,3527,3515,3503,3491,3479,3467,3455,3443,3431,3419,3407,3395,3383,3371,3359,3347,3335,3323,3311)#(3299)            # 模型版本（模型A）
$model_version_b         = $null#3275#3275             # 第二个模型版本号（集成模式），$null 表示不启用
